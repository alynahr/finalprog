...
public class signUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 130, 370, 370));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (users.stream().anyMatch(user -> user.email.equals(email))) {
            jLabel7.setText("Email already registered!");
            return;
        }
        
        users.add(new user(fullName, email, password));
        jLabel7.setText("Signup successful!");
